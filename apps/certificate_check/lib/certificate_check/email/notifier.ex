defmodule CertificateCheck.Notifier do
  @moduledoc """
  ...
  alias CertificateCheck.InvalidContent
  alias CertificateCheck.InvalidContents
  alias DigitalSignature.NifServiceAPI

  @email_sender Application.get_env(:certificate_check, :api_resolvers)[
                  :email_sender
                ]
